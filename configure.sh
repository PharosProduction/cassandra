...
sed -ri 's/^(# )?('"broadcast_address"':).*/\2 '"$POD_IP"'/' "$CASSANDRA_HOME/conf/cassandra.yaml"
sed -ri 's/^(# )?('"broadcast_rpc_address"':).*/\2 '"$POD_IP"'/' "$CASSANDRA_HOME/conf/cassandra.yaml"
...
sed -ri 's/^(# )?('"broadcast_address"':).*/\2 '"$POD_IP"'/' "$CASSANDRA_ETC/cassandra.yaml"
sed -ri 's/^(# )?('"broadcast_rpc_address"':).*/\2 '"$POD_IP"'/' "$CASSANDRA_ETC/cassandra.yaml"
